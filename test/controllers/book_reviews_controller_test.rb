...
class BookReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_review" do
    assert_difference("BookReview.count") do
      post book_reviews_url, params: { book_review: { book_id: @book_review.book_id, comment: @book_review.comment, library_id: @book_review.library_id, member_id: @book_review.member_id, rating_id: @book_review.rating_id, reviewdate: @book_review.reviewdate } }
    end
  ...
  test "should update book_review" do
    patch book_review_url(@book_review), params: { book_review: { book_id: @book_review.book_id, comment: @book_review.comment, library_id: @book_review.library_id, member_id: @book_review.member_id, rating_id: @book_review.rating_id, reviewdate: @book_review.reviewdate } }
