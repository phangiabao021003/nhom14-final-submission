...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference("Library.count") do
      post libraries_url, params: { library: { address: @library.address, library_id: @library.library_id, manager_id: @library.manager_id, no_staff: @library.no_staff } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { address: @library.address, library_id: @library.library_id, manager_id: @library.manager_id, no_staff: @library.no_staff } }
